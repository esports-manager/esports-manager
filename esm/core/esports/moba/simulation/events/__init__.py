...
from .moba_event_kill import MobaEventKill
...
class MobaEventFactory:
    ...
    def create_event(
        self, event_type, team1, team2, event_time: timedelta
    ) -> MobaEvent:
        if event_type == MobaEventType.NOTHING:
            return MobaEventNothing(team1, team2, event_time)
        elif event_type == MobaEventType.KILL:
            return MobaEventKill(team1, team2, event_time, self.get_points(event_type))
