    ...
    def layout(self) -> list:
        ...
        tab_home = [
            ...
            [
                esm_form_text("Team"),
                esm_form_text(
                    "TEAMNAME123456789101112131415", key="game_dashboard_oppteamname"
                ),
            ],
            [
                esm_table(
                    values=[["LANE", "PLAYERNAME1234567891011121314151617", "1515"]],
                    headings=["Lane", "Nickname", "Skill"],
                    key="game_dashboard_oppteamroster",
                    size=(100, 30),
                )
            ],
            [
        ...
        player_champion_data = [
            ...
            [
                esm_table(
                    values=[["No player selected", "00"]],
                    headings=["Champion Name", "Skill"],
            ...
            [
                esm_table(
                    values=[
                        [
                            "100",
                            "TEAMNAME12345678910111213141517181920",
                            "00",
                            "00",
                            "00",
                        ]
        ...
        tab_game_details = [
            ...
            [
                esm_table(
                    values=[["CHAMPION_NAME123456789101112", "100"]],
                    headings=["Champion Name", "Skill"],
                    key="game_dashboard_championstable",
                    size=(100, 30),
                )
            ],
        ]
        ...
        return [
            [
                esm_title_text(
                    "TEAMNAME1234567891011121314151617181920\n",
