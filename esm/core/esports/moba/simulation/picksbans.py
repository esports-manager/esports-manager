...
class PicksBans:
    ...
    def set_up_player_picks(self):
        self.picks_order = [
            self.team1.players[0],
            self.team2.players[0],
            self.team2.players[1],
            self.team1.players[1],
            self.team1.players[2],
            self.team2.players[2],
            self.team2.players[3],
            self.team1.players[3],
            self.team1.players[4],
            self.team2.players[4],
        ]
...
class PickBanAI:
    ...
    def get_best_champions(self, player) -> None:
        self.check_champion(player.champion_pool, self.best_champions)
    ...
    def get_opponents_best_champions(self) -> None:
        ...
        for player in self.team.list_players:
            self.check_champion(
                player.champion_pool, self.opponents_best_champions)
